...
export const FONTS = {
  xs: 10, sm: 12, md: 14, base: 16, lg: 18, xl: 20, xxl: 24, xxxl: 32, display: 48,
};

export const RADIUS = { sm: 4, md: 8, lg: 12, xl: 16, xxl: 24, full: 9999 };

export const CALL_RATES = {
  coinsPerMinute: 40,
  earningsPerThousandCoins: 50,
};
...
export const WITHDRAWAL = {
  minimumCoins: 1000,
  payoutDay: 'Sunday',
  coinsToRupees: (coins) => Math.floor((coins / 1000) * 50),
};